...
export class AdminServer {
    ...
    private setupRoutes() {
        ...
        this.app.use('/auth', createAuthRoutes(this.oauth));
        this.app.use('/admin', createAdminRoutes(this.oauth, this.deviceManager));
    ...
    public start(): Promise<void> {
        return new Promise((resolve) => {
            this.app.listen(config.server.adminPort, () => {
